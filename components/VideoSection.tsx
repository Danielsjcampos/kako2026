    ...
    <section className="py-24 bg-blue-950 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16">
          <span className="text-blue-400 font-black tracking-widest uppercase mb-4 block">Experiência AESJ</span>
        ...
        <div className="relative aspect-video rounded-[4rem] overflow-hidden shadow-[0_0_100px_rgba(37,99,235,0.2)] border-8 border-white/5 group">
          {videoId ? (
            <iframe 
          ...
          <div className="absolute inset-0 pointer-events-none bg-gradient-to-t from-blue-950/45 to-transparent flex items-end p-8 lg:p-16">
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-white/5 backdrop-blur-md p-10 rounded-[3rem] border border-white/10 group hover:bg-white/10 transition-all duration-500">
            <h3 className="text-2xl font-black text-blue-400 mb-4 uppercase tracking-tighter">Patrimônio Histórico</h3>
            <p className="text-blue-100/70 text-lg leading-relaxed font-medium">Preservamos cada detalhe do nosso Clube de Campo, para que sua família sempre tenha o melhor cenário em São José dos Campos.</p>
          </div>
          <div className="bg-white/5 backdrop-blur-md p-10 rounded-[3rem] border border-white/10 group hover:bg-white/10 transition-all duration-500">
            <h3 className="text-2xl font-black text-blue-400 mb-4 uppercase tracking-tighter">Gestão para Você</h3>
            <p className="text-blue-100/70 text-lg leading-relaxed font-medium">Não basta ser bonito, precisa ser bem gerido. Vamos focar na manutenção impecável e no lazer de qualidade para todas as idades.</p>
          </div>
        </div>
      </div>
