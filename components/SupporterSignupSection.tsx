...
const SupporterSignupSection: React.FC = () => {
  ...
  return (
    <section id="apoiar" className="py-24 bg-gray-50 overflow-hidden relative">
      {/* Social Proof Ticker */}
      <div className="absolute top-0 left-0 right-0 bg-blue-600/5 py-4 border-b border-blue-100 overflow-hidden whitespace-nowrap z-0">
        <div className="flex animate-marquee gap-8 items-center">
          {[...recentSupporters, ...recentSupporters].map((name, i) => (
            <div key={i} className="flex items-center gap-2 text-blue-900/40 font-black uppercase text-[10px] tracking-widest">
              <Heart size={12} fill="currentColor" /> {name} APOIA A RETOMADA 
            </div>
          ))}
          {recentSupporters.length === 0 && (
            <div className="text-blue-900/40 font-black uppercase text-[10px] tracking-widest">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12">
        <div className="bg-[#050b2b] rounded-[4rem] p-8 lg:p-20 relative overflow-hidden shadow-[0_40px_100px_-20px_rgba(30,58,138,0.5)]">
          {/* Decorative elements */}
          <div className="absolute -top-24 -right-24 w-[30rem] h-[30rem] bg-blue-600/20 rounded-full blur-[100px] animate-pulse" />
          <div className="absolute -bottom-24 -left-24 w-[20rem] h-[20rem] bg-red-600/10 rounded-full blur-[80px]" />
          
          <div className="flex flex-col lg:flex-row items-center gap-16 relative z-10">
            <div className="flex-1 text-center lg:text-left">
              <div className="inline-flex items-center gap-2 bg-blue-400/10 text-blue-400 px-4 py-2 rounded-full text-[10px] font-black uppercase tracking-widest mb-8 border border-blue-400/20">
              ...
              <div className="mb-8">
                <h2 className="text-5xl lg:text-7xl font-black text-white mb-6 leading-[1.1] tracking-tighter">
                  Junte-se à <br />
                  <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-blue-600">Mudança Agora.</span>
                </h2>
                <p className="text-blue-100/70 text-xl font-medium leading-relaxed max-w-xl">
              ...
              <div className="grid grid-cols-2 gap-4 mb-10">
                <div className="bg-white/5 border border-white/10 p-6 rounded-[2.5rem] backdrop-blur-md">
                  ...
                  <p className="text-[10px] font-black text-blue-400 uppercase tracking-widest">Sócios Apoiadores</p>
                </div>
                <div className="bg-white/5 border border-white/10 p-6 rounded-[2.5rem] backdrop-blur-md">
                  <p className="text-4xl font-black text-white mb-1">100%</p>
                  <p className="text-[10px] font-black text-blue-400 uppercase tracking-widest">Transparência</p>
                </div>
              </div>
            ...
            <div className="w-full max-w-md bg-white rounded-[3.5rem] p-8 lg:p-14 shadow-2xl relative">
              ...
              <div className="mb-10 text-center sm:text-left">
                <h3 className="text-3xl font-black text-blue-950 tracking-tight">Oficialize seu Apoio</h3>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="space-y-4">
                  <div>
                    <label className="text-[10px] font-black text-blue-900/50 uppercase tracking-widest mb-2 ml-4 block">Nome Completo</label>
                    <input 
                      type="text"
                      required
                      className="w-full px-8 py-5 bg-gray-50 border border-gray-100 rounded-[2rem] focus:outline-none focus:ring-4 focus:ring-blue-500/10 focus:bg-white transition-all font-bold text-blue-950 placeholder:text-gray-300"
                  ...
                  <div>
                    <label className="text-[10px] font-black text-blue-900/50 uppercase tracking-widest mb-2 ml-4 block">Nº de Título (Opcional)</label>
                    <input 
                      type="text"
                      className="w-full px-8 py-5 bg-gray-50 border border-gray-100 rounded-[2rem] focus:outline-none focus:ring-4 focus:ring-blue-500/10 focus:bg-white transition-all font-bold text-blue-950 placeholder:text-gray-300"
                      placeholder="Ex: 0000"
                  ...
                  <div>
                    <label className="text-[10px] font-black text-blue-900/50 uppercase tracking-widest mb-2 ml-4 block">WhatsApp / Telefone</label>
                    <input 
                      type="text"
                      required
                      className="w-full px-8 py-5 bg-gray-50 border border-gray-100 rounded-[2rem] focus:outline-none focus:ring-4 focus:ring-blue-500/10 focus:bg-white transition-all font-bold text-blue-950 placeholder:text-gray-300"
                ...
                <button 
                  type="submit"
                  disabled={isLoading}
                  className="w-full group bg-blue-600 text-white py-6 rounded-[2rem] font-black uppercase tracking-widest hover:bg-blue-700 hover:scale-[1.02] active:scale-[0.98] transition-all shadow-[0_20px_40px_-10px_rgba(37,99,235,0.4)] disabled:opacity-50 flex items-center justify-center gap-3 overflow-hidden relative"
                >
